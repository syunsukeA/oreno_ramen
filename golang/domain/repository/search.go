...
type Shop interface {
	...
	GetBookmarkShopByUserID(c *gin.Context, userID int64, num int64) (sos []*object.Shop, err error)
	GetEvaluateShopByUserID(c *gin.Context, userID int64, upper int64, lower int64) (sos []*object.Shop, err error)
}
